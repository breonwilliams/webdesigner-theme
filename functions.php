...
if (!function_exists('bootstrapBasicEnqueueScripts')) {
	...
	function bootstrapBasicEnqueueScripts() 
	{
		...
		wp_enqueue_style('pushNav-reset', get_template_directory_uri() . '/css/push-nav/reset.css');
		wp_enqueue_style('pushNav-style', get_template_directory_uri() . '/css/push-nav/style.css');
		...
		wp_enqueue_script('pushNav-main', get_template_directory_uri() . '/js/push-nav/main.js', array(), false, true);
...
// login redirect
require_once locate_template('/inc/redirect.php'); // Hide admin bar
